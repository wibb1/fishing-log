...
# trips
trip1 = Trip.create!(date: "05-20-2020", time: "08:45", latitude: 41.595, longitude: -70.81,  success: "Good", species: "bluefish", user_id: user1.id, shared: false, name: "
  First trip of the season",body: "The blues were thick off the rock 100 yards from shore.  If your bait managed to get through them then you had a shot at a bass.  We switched to a heavier sinker to get down a little quicker and it helped.  Blues are fun but you lose a lot of gear when you are trying to get bass
  ")
trip2 = Trip.create!(date: "06-20-2020", time: "08:45", latitude: 41.59, longitude: -70.843, success: "Bad", species: "striped bass", user_id: user1.id, shared: true, name: "
  Second Trip of the season", body: "We couldn't catch a cold today.  This is usally a great spot but the bright sun early in the season made the fish skittish.  Fishing is still better than work and it is always nice to get out on the boat but it is better when you are catching.
  ")
trip3 = Trip.create!(date: "06-20-2020", time: "08:45", latitude: 41.59, longitude: -70.843, success: "Good", species: "bluefish", user_id: user2.id, shared: true, name: "
  First trip", body: "Trolling for blues and my son and I had a ball. Several double hookups on a single troll.  Perfect eating size too, about 15-20 inches.  We had a blast trolling light tackle, tried casting for them but they seemed to be spread out along the shore.  Not sure what they were after but it is a spot to go back to.
  ")
trip4 = Trip.create!(date: "07-20-2020", time: "08:45", latitude: 41.59, longitude: -70.843,  success: "Bad", species: "fluke", user_id: user2.id, shared: false, name: "Fluke Fishing",body: "
  We had a tough day trying to get some fluke.  This is one of 5 or 6 spots.  We caught some small sea bass but were really after fluke and the sea bass were all small.  Maybe next time.  Fluke are getting harder and harder to find around here, not sure what is going on but fishing for them has become a real challenge.
  ")
